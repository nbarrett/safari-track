...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    title: "New features",
    changes: [
      "Live activity lock screen widget and remove push notifications",
    ],
  },
  {
    version: "1.9.0",
    ...
    title: "New features",
    changes: [
      "Track iOS project and fix blank screen on app resume",
    ],
  },
  {
    version: "1.8.1",
  ...
  },
  {
    ...
    title: "New features",
    changes: [
      "Add Capacitor native shell with background GPS",
    ],
  },
  {
    version: "1.7.13",
    ...
    title: "Bug fixes",
    changes: [
      "Graceful local fallback for photo capture and offline page",
    ],
  },
  {
    version: "1.7.12",
    ...
    title: "Bug fixes",
    changes: [
      "Robust service worker update detection",
    ],
  },
  {
    version: "1.7.11",
    ...
    title: "Bug fixes",
    changes: [
      "Wake lock, GPS buffer flush, route point accumulator, and drive resume",
    ],
  },
  {
    version: "1.7.10",
    ...
    title: "Bug fixes",
    changes: [
      "Offline mutation resilience and route line deduplication",
      "Flythrough sighting thumbnails and offline drive save",
    ],
  },
  {
    version: "1.7.9",
    ...
    title: "Bug fixes",
    changes: [
      "Shared auth card, landing page polish, and lodges back button",
    ],
  },
  {
    version: "1.7.8",
    ...
    title: "Bug fixes",
    changes: [
      "Pre-populate sign-in fields when redirecting from register page",
    ],
  },
  {
    version: "1.7.7",
